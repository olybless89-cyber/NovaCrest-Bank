...
|---|---|
| Region | Singapore |
| Third-party domain | `app-dptqkburek1u-api-GaDwzVOqmRNY.gateway.appmedo.com` |
| Method | `GET` |
| Upstream path | `/tasks` |
| API Plugin ID | `73eecc62-33b0-48d6-aa34-7d309680476b` |
| API Plugin API ID | `api-GaDwzVOqmRNY` |
| API Plugin endpoint | `GET https://app-dptqkburek1u-api-GaDwzVOqmRNY.gateway.appmedo.com/tasks` |
