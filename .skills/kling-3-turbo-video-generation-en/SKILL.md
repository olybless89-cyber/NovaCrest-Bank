...
- Text task creation: `POST https://app-dptqkburek1u-api-l9nZxREvJ6V9.gateway.appmedo.com/text-to-video/kling-3.0-turbo`
- Image task creation: `POST https://app-dptqkburek1u-api-e94GlB86xpEa.gateway.appmedo.com/image-to-video/kling-3.0-turbo`
- Unified task query: `GET https://app-dptqkburek1u-api-GaDwzVOqmRNY.gateway.appmedo.com/tasks`
...
async function queryTurboVideoTask(
  ...
  const response = await fetch(
    `https://app-dptqkburek1u-api-GaDwzVOqmRNY.gateway.appmedo.com/tasks?${query}`,
    {
      method: "GET",
      headers: {
...
const response = await fetch(
  "https://app-dptqkburek1u-api-l9nZxREvJ6V9.gateway.appmedo.com/text-to-video/kling-3.0-turbo",
  {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
...
```typescript
const response = await fetch(
  "https://app-dptqkburek1u-api-e94GlB86xpEa.gateway.appmedo.com/image-to-video/kling-3.0-turbo",
  {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
