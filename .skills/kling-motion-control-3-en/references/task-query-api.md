...
```http
GET https://app-dptqkburek1u-api-qYGWzQv1x4GY.gateway.appmedo.com/tasks?task_ids=TASK_ID
GET https://app-dptqkburek1u-api-qYGWzQv1x4GY.gateway.appmedo.com/tasks?external_task_ids=EXTERNAL_ID
