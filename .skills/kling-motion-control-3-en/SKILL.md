...
| Purpose | Endpoint |
|---|---|
| Create motion-control task | `POST https://app-dptqkburek1u-api-m9xKdopkqvMa.gateway.appmedo.com/motion-control/kling-3.0` |
| Query exact task IDs | `GET https://app-dptqkburek1u-api-qYGWzQv1x4GY.gateway.appmedo.com/tasks` |
